    ...
    protected function getStats(): array
    {
        ...
        return [
          ...
          Stat::make('Varian Paket Aktif', $activePackages->count() . ' Jenis Paket')
              ...
              ->chart([7, 3, 4, 5, 6, 3, 5, 8]) // Menambahkan chart
              ->color('indigo')
              ->extraAttributes([
          ...
          Stat::make('Margin Paket Tertinggi', 'Rp ' . number_format($mostProfitable['margin'] ?? 0, 0, ',', '.'))
              ...
              ->chart([2, 5, 10, 15, 25, 22, 30, 40]) // Chart tren naik (Profit)
              ->color('success')
              ->extraAttributes([
          ...
          // 4. BOTTLENECK (Production Constraint)
          Stat::make('Limit Kesiapan Terendah (Bottleneck)', ($bottleneckPackage['qty'] ?? 0) . ' Paket')
              ...
              ->chart([20, 18, 15, 12, 10, 8, 5, 2]) // Chart tren turun (Kritis)
              ->color('danger')
              ->extraAttributes([
          ...
          // 5. FULFILLMENT POWER (Aggregate Capacity)
          Stat::make('Total Peluang Penjualan', number_format($totalFulfillmentPower, 0, ',', '.') . ' Pesanan')
              ...
              ->chart([15, 20, 18, 25, 30, 28, 35, 40]) // Chart kapasitas
              ->color('warning')
              ->extraAttributes([
